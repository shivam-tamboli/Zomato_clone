...
import ShowUserFoods from './USER/ShowUserFoods' // FIXED: Added 's'
        ...
        return (
            <div>
                <Switch>
                    ...
                    <Route exact path="/User" component={ShowUserFoods}></Route> {/* FIXED: Updated component */}
                    <Route exact path="/Userrestaurant" component={ShowUserRestaurants}></Route>
                    <Route exact path="/Userfoods" component={ShowUserRestaurantFoods}></Route>
